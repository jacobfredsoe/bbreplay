...
function extractGameDetails(jsonObject) {
  ...
  return {
    fileName: lastStepRes.row.replayfilename,
    ...
    homeTeam: {
      data: {
        ...
        coachId: lastStepRes.coachresults.coachresult[0].idcoach,
        ...
        teamId: lastStepRes.coachresults.coachresult[0].teamresult.idteam
      },
      result: {
    ...
    awayTeam: {
      data: {
        ...
        coachId: lastStepRes.coachresults.coachresult[1].idcoach,
        ...
        teamId: lastStepRes.coachresults.coachresult[1].teamresult.idteam
      },
      result: {
